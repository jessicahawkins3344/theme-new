    ...
    >
      <div class="h-screen  bg-black/50 relative py-24 lg:py-28 lg:pb-36 overflow-hidden content-center">
        <div class="container px-8 mx-auto text-center">
            ...
            <h2 class="mb-4 text-6xl md:text-12xl font-bold tracking-px-n leading-tight font-sans text-white" data-aos="fade-up" data-aos-delay="400">About Mike Oddo</h2>
            ...
            <div class="mt-4 sm:mt-8">
                <a class="inline-block px-5 py-4 text-zinc-800 font-semibold tracking-tight bg-white hover:bg-zinc-300 rounded-lg focus:ring-4 focus:ring-indigo-300 transition duration-200" href="/contact" data-aos="fade-down" data-aos-delay="600">Contact</a>
            </div>
        </div>
      </div>
    </section>
