    ...
    <div class="relative overflow-hidden border-b-2">
        <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-24">
            ...
            <div class="absolute inset-0 size-full">
                ...
                <a class="py-3 px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-full border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none" href="#">
            ...
            <div class="absolute bottom-12 -start-20 -z-[1] size-48 bg-gradient-to-b from-zinc-400 to-white p-px rounded-lg">
                <div class="bg-white size-48 rounded-lg"></div>
            </div>

            <div class="absolute -top-12 -end-20 -z-[1] size-48 bg-gradient-to-t from-zinc-300 to-zinc-800 p-px rounded-full">
