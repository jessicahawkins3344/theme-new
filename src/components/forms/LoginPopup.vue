<template>
    <div v-if="visible" class="z-40 transition-all fixed inset-0 flex items-center justify-center bg-black/60 bg-opacity-75">
      <div class="bg-white mx-4 md:mx-0 p-8 rounded-lg shadow-lg w-full max-w-md relative" data-aos="zoom-in" data-aos-duration="500">
        ...
        <template v-if="!forgotPassword">
          <h2 class="text-2xl font-bold mb-4 font-calm tracking-wide">Login Form</h2>
        ...
        <template v-else>
          <h2 class="text-2xl font-bold mb-4 font-calm">Forgot Password Form</h2>
